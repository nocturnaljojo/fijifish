...
## Status: Phase 3 — All portals LIVE; RLS hardened (017 applied); flight_windows clean (0 FAILs); next: code-schema naming alignment (orders_open_at → order_open_at, .state → .status) + Supabase CLI linking + Twilio
